...
class Note extends FlxSprite
{
	...
	public function new(stepTime:Float, noteData:Int, noteType:String = 'default', strumLine:Int, ?prevNote:Note, ?isSustain:Bool = false)
	{
		super();
	...
	override function update(elapsed:Float)
	{
		if (mustPress)
		{
			var diff:Float = Math.abs((stepTime * Conductor.stepCrochet) - Conductor.songPosition);
