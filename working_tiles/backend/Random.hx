...
// From https://github.com/ceramic-engine/clay/blob/main/src/clay/Utils.hx
class Random
{
	...
	public static function uniqueId():String
	{
		...
		var result = base62Id(_nextUniqueInt0) + '-' + base62Id() + '-' + base62Id(_nextUniqueInt1) + '-' + base62Id() + '-' + base62Id(_nextUniqueInt2)
			+ '-' + base62Id() + '-' + base62Id(_nextUniqueInt3);
