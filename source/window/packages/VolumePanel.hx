...
class VolumePanel extends ExSprite<VolumePanel>
{
	...
	private var _outline:RoundedSprite;

	private var _tracker:Slider;

	override public function create()
	{
		_outline = new RoundedSprite(0, 0, _width + _outlineSize, _height + _outlineSize, [15], FlxColor.BLACK, 0.25);
		_bg = new RoundedSprite(_outlineSize * 0.5, _outlineSize * 0.5, _width, _height, [15], FlxColor.WHITE, 0.6);
